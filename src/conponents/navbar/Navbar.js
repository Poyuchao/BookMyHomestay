  ...
  return (
    <div className="navbar">
      <div className="navContainer">
        <span className="navLogo" onClick={handleLogoClick}>
          {logo}
        </span>
        ...
        <div className="navMenu">
          ...
          <div className="welcomeMessage">
            ...
            {props.loginUser ? (
              <span>
                Welcome {props.loginUser && props.loginUser.fname}{" "}
                {props.loginUser && props.loginUser.lname}
              </span>
            ) : (
